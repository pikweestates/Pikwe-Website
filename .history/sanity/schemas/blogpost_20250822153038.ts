...
export const blogpost = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      validation: (rule) =>
        rule.min(10).required().error("Please enter a title with about 10 characters"),
      fieldset: "title",
    }),
    ...
    defineField({
      ...
      validation: (rule) =>
        rule.required().error("Please select atleast one category"),
    }),
    ...
    defineField({
      ...
      validation: (rule) =>
        rule
          ...
          .max(400)
          .required()
          .error("Please enter an excerpt of about 120-400 characters"),
      fieldset: "excerpt",
    }),
