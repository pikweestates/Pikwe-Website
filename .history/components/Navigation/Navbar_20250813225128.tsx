...
const Navbar = ({setLocalState}: {setLocalState: React.Dispatch<React.SetStateAction<string>>}) => {
      ...
      <div className={styles.navbar__section}>
        <div className={`container ${styles.navbar__container}`}>
          ...
          <div className={styles.nav__right}>
            <LanguageSelector status="navbar" setActiveSide={setActiveSide} setLocalState={set}/>
