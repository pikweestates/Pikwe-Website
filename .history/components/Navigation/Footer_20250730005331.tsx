      ...
      <div className={`container ${styles.footer__container}`}>
            ...
            <div className={styles.fcr__right}>
              ...
              <div className={styles.fcr__content}>
                ...
                <div className={styles.fcr__bottom}>
                  ...
                  <Link href="https://www.instagram.com/pikwe_estates"  className={styles.fcr__div}><span className={styles.fc__bold}>S:</span> @pikwe_estates</Link>
        ...
        <div className={styles.fc__bottom}>
          ...
          <div className={styles.fc__footer}>
              ...
              <Link href={currentlocale==="en" ? "/en/privacy" : "/fr/confidentialité"}>Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
