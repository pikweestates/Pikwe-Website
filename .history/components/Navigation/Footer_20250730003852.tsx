        ...
        <div className={styles.fc__top}>
          ...
          <div className={styles.fct__right}>
            ...
            <div className={styles.fcr__right}>
              <div className={styles.fcr__content}>
              <span className={styles.fc__span}>NAVIGATION</span>
              <p className={styles.fc__p}>We believe that transparent guidance, local expertise, and honest partnerships can turn land ownership from a daunting process into an empowering foundation for your future while also fostering community growth, lasting relationships, and peace of mind.</p>
              </div>
