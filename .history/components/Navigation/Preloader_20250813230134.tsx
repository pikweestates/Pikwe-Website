...
const Preloader = ({setAnimationFinished, localState}: {setAnimationFinished: React.Dispatch<React.SetStateAction<boolean>>, localState: string;}) => {
  ...
  return (
    <div className={styles.preloader} ref={preloaderRef}>
          {localState === "Translating State" && (
            <AnimatedPhrase phrase={phrase} setAnimFinished={setAnimFinished} />
          )}
