...
const Preloader = ({
 ...
 Handle timeline resume logic useEffect(() => { const shouldResume = currentValue === 100 || animFinished; if (shouldResume && timelineRef.current && !hasResumed.current) { hasResumed.current = true; setTimeout(() => { timelineRef.current?.resume(); }, 1000); } }, [currentValue, animFinished]);
