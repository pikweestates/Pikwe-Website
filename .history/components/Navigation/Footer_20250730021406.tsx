      ...
      <div className={`container ${styles.footer__container}`}>
        ...
        <div className={styles.fc__bottom}>
          ...
          <div className={styles.fc__footer}>
            ...
            <Link
              href={
                currentlocale === "en" ? "/en/privacy" : "/fr/confidentialité"
              }
            >
              {t("Navigation:privacy")}
            </Link>
            <span>{t("Navigation:webby")} <span className={styles.underline} onClick={() => setActiveBetter(!activeBetter)}>BetterMarque</span></span>
          </div>
        </div>
        <BetterMarque
