      ...
      <div className={`container ${styles.footer__container}`}>
        <div className={styles.fc__top}>
          <div className={styles.fct__left}>
            <div className={styles.fcl__image}>
            ...
            <div className={styles.fcr__right}>
              ...
              <div className={styles.fcr__content}>
                ...
                <div className={styles.fcr__bottom}>
                  ...
                  <Link href="https://www.instagram.com/pikwe_estates" target="_blank" className={styles.fcr__div}><span className={styles.fc__bold}>S:</span> @pikwe_estates</Link>
