              ...
              <div className={styles.accordion} key={i}>
                <div className={styles.acc__head}>
                  ...
                  <div className={styles.ah__right}>
                    <h2 className={styles.acc__h2}>{data.}</h2>
                  </div>
                </div>
                <div className={styles.acc__body}>
                  <div className={styles.acb__content}>
                    <p className={styles.acb__p}>
                      We make real estate education accessible to everyone
                      because we believe that every Cameroonian deserves to
                      understand how real estate really works.
                    </p>
