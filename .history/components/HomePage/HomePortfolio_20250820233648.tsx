...
const HomePortfolio = ({properties}: {properties: Property[]}) => {
  ...
  const portfolioContent = [
    ...
    {
      id: properties[1]._id,
      ref: properties[1].reference.current,
      ...
      link: `/${currentlocale}/portfolio/${properties[1].slug.current}`
    },
    {
      id: properties[2]._id,
      ref: properties[2].reference.current,
      ...
      link: `/${currentlocale}/portfolio/${properties[2].slug.current}`
    },
  ];
