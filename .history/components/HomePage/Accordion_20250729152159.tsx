...
const Accordion = ({lenis, data, index, activeAccordion, setActiveAccordion}: {lenis: Lenis | null, index: number, data: DataInterface, activeAccordion: number, setActiveAccordion: }) => {
