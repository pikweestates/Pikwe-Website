...
const HomePageWrapper = () => {
  ...
  // When preloader finishes, mark visited
  useEffect(() => {
    if (animationFinished) onFinished();
  }, [animationFinished, onFinished]);


  return (
    <>
      <Preloader setAnimationFinished={setAnimationFinished} localState={localstate}/>
      <Navbar setLocalState={setLocalState} animationFinished={animationFinished}/>
      <HeroSection mainData={mainData} linkData={linkData} animationFinished={animationFinished} />
