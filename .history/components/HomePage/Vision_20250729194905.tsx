  ...
  return (
    <div className={styles.vision__section}>
      ...
      <div className={styles.vision__content}>
        ...
        <p>We envision to become the real estate company of preference by providing premium services and opening doors to life-changing opportunities for millions of people in Cameroon and beyond.</p>
      </div>
    </div>
  );
};
