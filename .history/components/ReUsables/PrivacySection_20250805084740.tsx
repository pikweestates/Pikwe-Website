      ...
      <div className={styles.privacy__container}>
        ...
        <div className={styles.privacy}>
          ...
          <div className={styles.p__content}>
            ...
            <p className={styles.p__p}>
            The Website serves to introduce Pikwe Estates, showcase our land-ownership services, and give clients and partners secure access to their inquiries and transaction details. This Policy covers: (i) any data Pikwe Estates collects when you browse or interact with the Website; (ii) information you send us via email, contact forms, or messaging channels; and (iii) data we obtain from trusted third-party sources. The Website is intended for users aged 18 and over. If you are under 18, please do not submit personal information through any Pikwe Estates channels.
