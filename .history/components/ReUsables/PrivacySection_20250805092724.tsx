          ...
          <div className={styles.p__content2}>
            ...
            <div className={styles.p__content}>
              ...
              <li className={styles.p__list}>
                ...
                <ul className={styles.p__ul}>
                Essential cookies keep the site functional, analytics cookies measure traffic and user behavior, and marketing cookies help us present relevant offers. You can instruct your browser to refuse all
                  ...
                  setting so that it will refuse cookies, our website will use cookies0
                </ul>
                <ul className={styles.p__ul}>
                  Additional Messages: Any extra information you include helps
                  us understand your specific goals and tailor our advice
