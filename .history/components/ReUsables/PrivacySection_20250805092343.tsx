      ...
      <div className={styles.privacy__container}>
        ...
        <div className={styles.privacy}>
          ...
          <div className={styles.p__content2}>
            ...
            <div className={styles.p__content}>
              <p className={styles.p__p}>
              We automatically collect technical and behavioral data when you browse and interact with www.pikweestates.com to optimize performance and personalize content.
              </p>
              <li className={styles.p__list}>
                <ul className={styles.p__ul}>
                  Full Name: We use this to personalize our responses and match
