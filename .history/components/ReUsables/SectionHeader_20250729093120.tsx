  ...
  return (
    <div className={styles.sh__wrapper}>
      ...
      <div className={styles.sh__right}>
        <p className={styles.sh__p}>Discover each step, from identifying plots and verifying titles to conducting surveys, notarizing sales, processing dossiers, and applying for mutation. Get the full roadmap with instructions.</p>
      </div>
    </div>
  )
}
