      ...
      <div className={styles.privacy__container}>
        ...
        <div className={styles.privacy}>
          ...
          <div className={styles.p__content2}>
            ...
            <div className={styles.p__content}>
              <p className={styles.p__p}>
              When you contact us through our form, request a consultation, or create an account, we collect certain personal details to identify you and facilitate clear communication.
              </p>
            </div>
          </div>
        </div>
