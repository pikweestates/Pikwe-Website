      ...
      <div className={styles.privacy__container}>
        ...
        <div className={styles.privacy}>
          ...
          <div className={styles.p__content2}>
            <h4 className={styles.p__h4}>When you contact us through our form, request a consultation, or send us a whatsapp, we collect certain personal details to identify you and facilitate clear communication.</h4>
            <div className={styles.p__content}>
              <p className={styles.p__p}>
                This Policy covers only the personal data we collect via our
                Website, email, phone, and other electronic channels. It does
                not apply to unsolicited information such as ideas, feedback, or
                suggestions you submit outside of our request. Any such
                unsolicited submissions to Pikwe Estates are non-confidential,
                and we may use, reproduce, or share them freely without
                attribution.
              </p>
            </div>
          </div>
