        ...
        <div className={styles.privacy}>
          ...
          <div className={styles.p__content}>
            ...
            <p className={styles.p__p}>
              ...
              covers: (i) any data Pikwe Estates collects when you browse or
              interact with the Website; (ii) information you send us via email,
              contact forms, or messaging channels; and (iii) data we obtain
              from trusted third-party sources. The Website is intended for
              users aged 18 and over. If you are under 18, please do not submit
              personal information through any Pikwe Estates channels.
            </p>
            <li className={styles.p__list}>
              <ul className={styles.p__ul}>
              Any data Pikwe Estates collects when you browse or
              interact with the Website
              </ul>
              <ul className={styles.p__ul}>
              information you send us via email,
              contact forms, or messaging channels
              </ul>
              <ul className={styles.p__ul}>
                Your rights to access, correct, or delete certain information.
              </ul>
