...
const Copy = ({
  ...
  // }
    ...
    if (Children.count(children) === 1 && React.isValidElement(children)) {
      // Narrow child to any HTML element props
      const child = children as ReactElement<Partial<JSX.IntrinsicElements[keyof JSX.IntrinsicElements]>>;
  
      return cloneElement(child, {
        ref: containerRef,
        className: [child.props.className ?? "", hidden ? "copy-hidden" : ""]
          .filter(Boolean)
          .join(" "),
      });
    }
