    ...
    <div className={styles.overlay}>
      <div className={styles.modal}>
        <div className={styles.modal__top}>
          ...
          <p>
           To provide you with the best experience, we use essential cookies that help our website function properly.
          </p>
        </div>
        <div className={styles.modal__bottom}>
        <Link href={currentlocale==="en" ? "/en/privacy" : "/fr/confidentialite"}>{t("Navigation:privacy")}</Link>
