    ...
    <div className={styles.privacy__container}>
      <div className={styles.privacy}>
        ...
        <div className={styles.p__content}>
          ...
          <p className={styles.p__p}>By using this Website, you agree to be bound by this Privacy Policy, the Terms of Use, and all disclaimers and other terms and conditions that appear on www.pikweestates.com..</p>
        </div>
      </div>
    </div>
  </div>;
