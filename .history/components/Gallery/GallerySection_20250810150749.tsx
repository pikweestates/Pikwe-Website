...
const GallerySection = ({
  ...
  const galleryContent = [
    {
      image: IMAGE,
      text: "Newly developed residential plot features clearly Newly developed residential plot features clearly marked sections, paved access roads, and central water infrastructure, set against serene rural landscapes.",
    },
    {
      image: IMAGE2,
      ...
      <AnimatePresence mode="wait">
        {activeModal && (
          <motion.div
            ...
            animate={activeModal ? "enter" : "initial"}
            exit="closed"
