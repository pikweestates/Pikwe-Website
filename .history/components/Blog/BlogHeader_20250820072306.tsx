...
const BlogHeader = ({ animationFinished }: { animationFinished: boolean }) => {
  //Translations
  ...
  return (
    <div className={styles.bh__section}>
      <div className={`container ${styles.bh__container}`}>
        ...
        <div className={styles.bh__bottom} style={{opacity: animationFinished ? 1 : 0, transition: "opacity 0.5s ease"}}>
