...
const PortfolioSection = ({
  ...
  const filters = [
    ...
    },
    {
      ...
      filters: [{name: "Size", slug: "size"}, {name: "500m² - 1000m²", slug: "500m²-1000m²"}, {name: "1000m² - 10000m²", slug: "1000m²-10000m²"}, {name: "> 10000m²", slug: ">10000m²"}],
    },
    {
      filterName: {
        fn: "Status",
    ...
    <div ref={ref} className={`section ${styles.ps__section}`}>
      <div className={`container ${styles.ps__container}`}>
        <div className={styles.ps__filter}>
          <h2 className={styles.filter__h2}>{t("Portfolio:filte")}</h2>
