...
const FilterContainer = ({filterData}: {filterData: FilterInterface }) => {
  ...
  return (
    <div className={styles.filter__container} onClick={() => setActiveModal((v) => !v)}>
      ...
      <div className={`${styles.fc__bottom} ${activeModal ? styles.active__modal : ""} ${filterData.filterName.slug==="size" && styles.fc__bottom2}`}>
