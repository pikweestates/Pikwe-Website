...
const PortfolioSection = ({
  ...
  const filters = [
    ...
    },
    {
      ...
      filters: [{name: "Size", slug: "size"}, {name: "500 - 1000", slug: "500-1000"}, {name: "1000 - 10000", slug: "1000-10000"}, {name: "> 10000", slug: ">10000"}],
    },
    {
      filterName: {
        fn: "Status",
      ...
      filters: [{name: "Status", slug: "status"}, {name: "Titled", slug: "titled"}, {name: "Non-titled", slug: "non-titled"}, {name: "5M - 10M", slug: "5M-10M"}, {name: "> 10M", slug: ">10M"}],
